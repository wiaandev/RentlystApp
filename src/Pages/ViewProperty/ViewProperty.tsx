...
export const ViewProperty = () => {
  ...
  return (
    <>
      ...
      <House />{' '}
      <Typography>{data.property.propertyAddress?.province}</Typography>
      <House />{' '}
      <Typography>{data.property.propertyAddress?.streetName}</Typography>
      <House />{' '}
      <Typography>{data.property.propertyAddress?.streetNumber}</Typography>
      <Typography>
        {data.property.bedroomAmount} bedroom {data.property.propertyType}
      </Typography>
