...
export const PropertyListingsCard = (
  {propertyListingsCardRef}: PropertyListingsCardProps,
) => {
      ...
      <Grid2 size={12} container alignItems={'center'} columnGap={2} mb={2}>
        ...
        <Grid2>
          <Typography variant={'h2'}>
            {data.propertyType.toLocaleLowerCase()}
          </Typography>
      ...
      <Grid2 size={'grow'} container alignItems={'center'} columnGap={2} mb={2}>
        ...
        >
          ...
          <Grid2 container size={'grow'} justifyContent={'flex-end'}>
            <Button
              onClick={() => navigate(`/listings/view/${data.id}`)}
              variant={'contained'}
            >
              View
            </Button>
